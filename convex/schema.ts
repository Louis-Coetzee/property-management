...
.index("by_company", ["companyId"])
  ...
  // Sites table (FA compatibility — stores site-wide config including payment gateways)
  sites: defineTable({
    name: v.string(),
    domain: v.string(),
    description: v.string(),
    ...
    createdAt: v.string(),
    updatedAt: v.string(),
    userRoles: v.optional(v.array(v.object({
      userId: v.id("users"),
    ...
    settings: v.optional(v.object({
      ...
      facebookPixel: v.optional(v.string()),
      primaryColor: v.optional(v.string()),
      secondaryColor: v.optional(v.string()),
      email: v.optional(v.string()),
      contactNumber: v.optional(v.string()),
      address: v.optional(v.string()),
      webAddress: v.optional(v.string()),
      ...
      inquiryContacts: v.optional(v.array(v.object({
        id: v.string(),
        firstName: v.string(),
        lastName: v.string(),
        email: v.string(),
      ...
      adminNotificationEmails: v.optional(v.array(v.string())),
      siteMode: v.optional(v.object({
        comingSoonEnabled: v.optional(v.boolean()),
        maintenanceEnabled: v.optional(v.boolean()),
        comingSoonAutoDisableAt: v.optional(v.string()),
        maintenanceAutoDisableAt: v.optional(v.string()),
        comingSoonMessage: v.optional(v.string()),
        maintenanceMessage: v.optional(v.string()),
      })),
      payment: v.optional(v.object({
        bookingPaymentBankName: v.optional(v.string()),
        bookingPaymentAccountHolder: v.optional(v.string()),
        bookingPaymentAccountNumber: v.optional(v.string()),
        bookingPaymentBranchCode: v.optional(v.string()),
        bookingPaymentAccountType: v.optional(v.string()),
        bookingPaymentSwiftCode: v.optional(v.string()),
        bookingPaymentReference: v.optional(v.string()),
        bookingPaymentInstructions: v.optional(v.string()),
        payfast: v.optional(v.object({
          enabled: v.optional(v.boolean()),
        ...
        paygate: v.optional(v.object({
          enabled: v.optional(v.boolean()),
          liveMode: v.optional(v.boolean()),
          payGateId: v.optional(v.string()),
          encryptionKey: v.optional(v.string()),
        })),
        notificationEmails: v.optional(v.array(v.string())),
        defaultGateway: v.optional(v.union(v.literal("payfast"), v.literal("paygate"))),
      })),
      contactPagePersons: v.optional(v.array(v.object({
        id: v.string(),
        firstName: v.string(),
        lastName: v.string(),
        email: v.string(),
        ...
        officeContactNumber: v.string(),
      }))),
      heroImages: v.optional(v.array(v.string())),
      heroImagesList: v.optional(v.array(v.object({
        url: v.string(),
        heading: v.optional(v.string()),
        text: v.optional(v.string()),
      }))),
      heroStaticImage: v.optional(v.string()),
      heroStaticHeading: v.optional(v.string()),
      heroStaticText: v.optional(v.string()),
      useStaticHero: v.optional(v.boolean()),
      googleAnalyticsConfig: v.optional(v.object({
