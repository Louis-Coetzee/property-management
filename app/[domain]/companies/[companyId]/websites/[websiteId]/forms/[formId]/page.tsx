      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-10 backdrop-blur-sm bg-white/95">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 py-4 text-sm">
            ...
            <ChevronRight className="h-4 w-4 text-slate-400" />
            <a href={`/companies/${companyId}/websites/${websiteId}/forms`} className="text-slate-500 hover:text-slate-700 transition-colors">
              Forms
            </a>
            <ChevronRight className="h-4 w-4 text-slate-400" />
            <span className="text-slate-900 font-medium">{isNewForm ? 'Create Form' : 'Edit Form'}</span>
          </div>
        </div>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex items-center gap-3 sm:gap-4">
            <button
              onClick={() => router.push(`/${domain}/companies/${companyId}/websites/${websiteId}/forms`)}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {user && (
          <FormBuilder
            ...
            onSave={(savedFormId) => {
              router.push(`/${domain}/companies/${companyId}/websites/${websiteId}/forms`);
            }}
            onCancel={() => {
              router.push(`/${domain}/companies/${companyId}/websites/${websiteId}/forms`);
            }}
