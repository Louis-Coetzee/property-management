...
import {
  ArrowLeft, Save, Send, Download, Share2, X, Plus, Trash2,
  Search, Calendar, User, Building2, Phone, Mail, MapPin,
...
export default function NewInvoicePage() {
  ...
  const handleSave = async (send: boolean = false) => {
    ...
    if (scheduledSend && scheduledDate) {
      ...
      scheduledSendAt = new Date(year, month - 1, day, hours, minutes).getTime();
    }
    ...
    try {
      const result = await createInvoice({
        ...
        scheduledSendAt,
        scheduledSendTo: scheduledEmail || undefined,
        scheduledSendTime: scheduledSend ? scheduledTime : undefined,
      });
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">Create a new invoice for your client</p>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1.5">
                        {recurringInterval === 'days'
                          ? `Every ${recurringDays} days`
                          : `Day ${recurringDayOfMonth} of each month`}
                      </p>
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
              ...
              <div className="flex items-center gap-3 mb-4">
                <input
                  ...
                  className="h-5 w-5 text-slate-900 rounded border-slate-300 focus:ring-slate-900"
                />
                <label htmlFor="scheduledSend" className="text-sm font-medium text-slate-700">
                  Schedule this invoice to be sent later
                </label>
              </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-900"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-2">Send At</label>
                      <select
                        value={scheduledTime}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-2">Send To (optional)</label>
                      <input
                        type="email"
