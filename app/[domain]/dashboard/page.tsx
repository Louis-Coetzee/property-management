...
export default function DashboardPage() {
  ...
  // For non-Refresh Tech domains, show a simplified user dashboard
  if (!isRefreshTech) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-8">My Account</h1>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Profile */}
            <Link href="/profile" className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg transition-all">
            ...
            {/* My Orders */}
            <Link href="/dashboard/orders" className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg transition-all">
            ...
            {/* My Bookings */}
            <Link href="/dashboard/bookings" className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg transition-all">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4">
                <Calendar className="h-6 w-6 text-emerald-600" />
              </div>
              <h3 className="text-lg font-semibold text-slate-900">My Bookings</h3>
              <p className="text-sm text-slate-500 mt-1">View your bookings</p>
            </Link>
            
            {/* Favourites */}
            <Link href="/dashboard/favourites" className="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg transition-all">
              <div className="w-12 h-12 bg-rose-100 rounded-xl flex items-center justify-center mb-4">
                <Heart className="h-6 w-6 text-rose-600" />
              </div>
              <h3 className="text-lg font-semibold text-slate-900">Favourites</h3>
              <p className="text-sm text-slate-500 mt-1">Your saved items</p>
            </Link>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="glow-border-wrapper-orange">
                      <Link
